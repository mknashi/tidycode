...
echo ""
echo "Public URLs (using pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev):"
echo ""
echo "macOS:"
echo "  Universal DMG:   https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-mac-universal.dmg"
echo "  ARM64 DMG:       https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-mac-arm64.dmg"
echo "  x64 DMG:         https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-mac-x64.dmg"
echo ""
echo "Windows:"
echo "  x64 MSI:         https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-windows-x64.msi"
echo "  x64 Installer:   https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-windows-portable.exe"
echo ""
echo "Linux:"
echo "  AppImage:        https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-linux-x86_64.AppImage"
echo "  DEB Package:     https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-linux-amd64.deb"
echo "  RPM Package:     https://pub-73b0ec13d5ad4a2faf3ee5bacea83252.r2.dev/TidyCode-${VERSION}-linux-x86_64.rpm"
